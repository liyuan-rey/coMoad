...
// Source File Name:   PackageAllList.java
...
public class PackageAllList extends JDialog
    implements ActionListener
{

    public PackageAllList(ObjectModelingConstruction mainFrame)
    {
    ...
    public void makeModelTable()
    {
        ...
        for(int i = 0; i < modelDataAL.size(); i++)
        {
            ...
            dataDetailInfo.add((Boolean)((DOSChangeable)modelDataAL.get(i)).get("isGlobal"));
    ...
    public void getAllModel()
    {
        try
        {
            ...
            modelDataAL = dos.listAllPackage();
        }
