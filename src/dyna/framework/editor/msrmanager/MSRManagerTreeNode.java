...
// Source File Name:   MSRManagerTreeNode.java
...
public class MSRManagerTreeNode extends DefaultMutableTreeNode
{

    public MSRManagerTreeNode()
    {
    }

    public MSRManagerTreeNode(Object userObject)
    {
        super(userObject);
    }
