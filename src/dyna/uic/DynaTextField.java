...
// Source File Name:   DynaTextField.java
...
public class DynaTextField extends JPanel
    implements DynaComponent
{
    ...
    public DynaTextField(Document doc, String text, int columns, String field, String identifier, String name, String titleText, 
    ...
    public DynaTextField(Document doc, String text, int columns, String titleText)
    {
        DynaTextField(doc, text, columns, null, null, null, titleText, -1, true, false, true, "String", 0.0D);
    }

    public DynaTextField(Document doc, String text, int columns)
    {
        DynaTextField(doc, text, columns, null, null, null, "", -1, false, false, true, "String", 0.0D);
    }

    public DynaTextField(int columns, String field, String identifier, String name, String titleText, int titleWidth, boolean titleVisible, 
    ...
    public DynaTextField(int columns, String titleText)
    {
        DynaTextField(columns, null, null, null, titleText, -1, true, false, true, "String", 0.0D);
    }

    public DynaTextField(int columns)
    {
        DynaTextField(columns, null, null, null, "", -1, false, false, true, "String", 0.0D);
    }

    public DynaTextField(String text, String field, String identifier, String name, String titleText, int titleWidth, boolean titleVisible, 
            boolean mandatory, boolean editable, String dataType, double dataSize)
    {
        tempWidth1 = 0;
        icon = null;
    ...
    public DynaTextField(String text, String titleText)
    {
        DynaTextField(text, null, null, null, titleText, -1, true, false, true, "String", 0.0D);
    }

    public DynaTextField(String text)
    {
        DynaTextField(text, null, null, null, "", -1, false, false, true, "String", 0.0D);
    }

    public DynaTextField(String text, int columns)
    {
        tempWidth1 = 0;
        icon = null;
        editableIconVisible = false;
