...
//            ObjectModelingConstruction, ModelInformation, ClassInformation, ScriptSelection
    ...
    implements ActionListener, MouseListener
{
    ...
    public void initialize()
    {
        ...
        eventTableScrPane.setPreferredSize(new Dimension(360, 330));
    ...
    public void setOuid(String ouid)
    {
        try
        {
            ...
            if(parent instanceof ModelInformation)
            {
                DOSChangeable dosModel = dos.getModel(ouid);
                modelName = (String)dosModel.get("name");
                clearAllField();
                refreshEventTable(ouid);
            } else
            if(parent instanceof ClassInformation)
            {
                DOSChangeable dosClass = dos.getClass(ouid);
                classCode = (String)dosClass.get("code");
                clearAllField();
                refreshEventTable(ouid);
            }
        }
    ...
    public void refreshEventTable(String ouid)
    {
        try
        {
            ...
            if(parent instanceof ModelInformation)
                eventList = dos.listEventForModel(ouid);
            else
            if(parent instanceof ClassInformation)
    ...
    public ArrayList setTypeComboBox()
    {
        ...
        if(parent instanceof ModelInformation)
        {
            typeAL.add("model.opened");
            typeAL.add("EVENT_MODEL_OPENED");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("model.closed");
            typeAL.add("EVENT_MODEL_CLOSED");
            returnAL.add(typeAL.clone());
            typeAL.clear();
        } else
        if(parent instanceof ClassInformation)
        {
            typeAL.add("add.before");
            typeAL.add("EVENT_ADD_BEFORE");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("add.after");
            typeAL.add("EVENT_ADD_AFTER");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("add.init");
            ...
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("remove.before");
            typeAL.add("EVENT_REMOVE_BEFORE");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("remove.after");
            typeAL.add("EVENT_REMOVE_AFTER");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("update.before");
            typeAL.add("EVENT_UPDATE_BEFORE");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("update.after");
            typeAL.add("EVENT_UPDATE_AFTER");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("read.before");
            typeAL.add("EVENT_READ_BEFORE");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("read.after");
            typeAL.add("EVENT_READ_AFTER");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("link.before");
            typeAL.add("EVENT_LINK_BEFORE");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("link.after");
            typeAL.add("EVENT_LINK_AFTER");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("unlink.before");
            typeAL.add("EVENT_UNLINK_BEFORE");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("unlink.after");
            typeAL.add("EVENT_UNLINK_AFTER");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("wip.add.before");
            typeAL.add("EVENT_WIP_ADD_BEFORE");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("wip.add.after");
            typeAL.add("EVENT_WIP_ADD_AFTER");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("file.attach.before");
            typeAL.add("EVENT_FILE_ATTACH_BEFORE");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("file.attach.after");
            typeAL.add("EVENT_FILE_ATTACH_AFTER");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("file.detach.before");
            typeAL.add("EVENT_FILE_DETACH_BEFORE");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("file.detach.after");
            typeAL.add("EVENT_FILE_DETACH_AFTER");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("file.checkin.before");
            typeAL.add("EVENT_FILE_CHECKIN_BEFORE");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("file.checkin.after");
            typeAL.add("EVENT_FILE_CHECKIN_AFTER");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("file.checkout.before");
            typeAL.add("EVENT_FILE_CHECKOUT_BEFORE");
            returnAL.add(typeAL.clone());
            typeAL.clear();
            typeAL.add("file.checkout.after");
            typeAL.add("EVENT_FILE_CHECKOUT_AFTER");
            returnAL.add(typeAL.clone());
            typeAL.clear();
        }
        return returnAL;
