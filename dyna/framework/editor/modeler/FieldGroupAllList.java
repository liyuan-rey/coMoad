...
// Source File Name:   FieldGroupAllList.java
...
public class FieldGroupAllList extends JDialog
    implements ActionListener
{

    public FieldGroupAllList(ObjectModelingConstruction mainFrame)
    {
    ...
    public void makeModelTable()
    {
        ...
        for(int i = 0; i < modelDataAL.size(); i++)
        {
            ...
            dataDetailInfo.add((Integer)((DOSChangeable)modelDataAL.get(i)).get("index"));
    ...
    public void getAllModel()
    {
        try
        {
            ...
            classDataAL = dos.listFieldGroup();
            modelDataAL = dos.listFieldGroup();
        }
