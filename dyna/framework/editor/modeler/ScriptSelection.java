...
//            ObjectModelingConstruction, EventInformation, ActionInformation
    ...
    implements ActionListener
{
    ...
    public void okButton_actionPerformed(ActionEvent e)
    {
        ...
        if(parent instanceof ActionInformation)
            ((ActionInformation)parent).setScriptNameTextField(name);
        dispose();
    }
