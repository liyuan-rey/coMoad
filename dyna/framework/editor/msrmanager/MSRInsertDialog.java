...
// Source File Name:   MSRInsertDialog.java
...
//            MSRInformation, MSRManager

public class MSRInsertDialog extends JDialog
    implements ActionListener
{

    public MSRInsertDialog(MSRManager userManager, Object contentPanel, DefaultMutableTreeNode parent)
    {
        ...
        this.parent = null;
        this.parent = parent;
        if(contentPanel instanceof MSRInformation)
            dssInformation = (MSRInformation)contentPanel;
        initialize();
    }
